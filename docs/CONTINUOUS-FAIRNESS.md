...
The response compares the fairness risk score, chaos resilience, worst disparate impact, acceptance rate, and experiment IDs.
...
- Minimum fairness risk score (JSON field: `minimum_certificate`)
- Minimum chaos resilience
- Minimum worst-case disparate impact
- Maximum risk-score regression (JSON field: `maximum_certificate_regression`)
